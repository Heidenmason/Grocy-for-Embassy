...
grocy.s9pk: manifest.yaml assets/compat/config_spec.yaml assets/compat/config_rules.yaml image.tar instructions.md $(ASSET_PATHS)
	embassy-sdk pack
...
grocy/target/aarch64-unknown-linux-musl/release/grocy: $(HELLO_WORLD_SRC)
